...
const DrawerContent = props => {
  ...
  useEffect(() => {
    if (
      props.isLogin &&
      props.getUserProfileResponse !== prevUserProfileResRef.current &&
      props.getUserProfileResponse?.success &&
      props.getUserProfileResponse?.data
    ) {
    ...
    <>
        ...
        <View
          style={{
            backgroundColor: isDarkMode
              ...
              : colors.headerbgcolor,
            paddingBottom: isIPad ? 60 : 30,
            paddingTop: IOS ? 80 : 30,
          }}>
      ...
      <View
        ...
        <TextInput
          ...
          style={{
            height: 40,
            fontFamily: isRTL ? fonts.arabicMedium : fonts.primary, // backgroundColor: '#f7f7f7',
            width: '80%',
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            ...
            props.navigation.navigate('SearchPost', {
      ...
      <View
        ...
        <View style={{flexDirection: 'row', alignItems: 'center'}}>
          <TouchableOpacity
            ...
            <Text
              style={[
                globalstyle.draweritemtext,
                !isRTL && {color: colors.orange},
              ]}>
              English
            </Text>
          </TouchableOpacity>
      ...
      <DrawerContentScrollView
        ...
        <DrawerItem
          key={21312}
          item={{title: strings.LiveStream, nav: 'LiveStream'}}
          navigation={props.navigation}
          activescreen={props.currentScreen}
        />
        <DrawerItem
          key={0}
          item={{title: strings.home, nav: 'Home'}}
          navigation={props.navigation}
          activescreen={props.currentScreen}
        />
        {drawerMenu.length > 0 &&
        ...
        <DrawerItem
          key={100}
          item={{title: strings.questionanswer, nav: 'QuestionAnswer'}}
          navigation={props.navigation}
          activescreen={props.currentScreen}
        />
        <DrawerItem
          key={101}
          item={{title: strings.contactus, nav: 'Contact'}}
          navigation={props.navigation}
          activescreen={props.currentScreen}
        />
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <Icon
              ...
              size={16}
            />
            <Text style={[globalstyle.draweritemtext, {color: colors.white}]}>
              {strings.logout}
            </Text>
          </TouchableOpacity>
        </View>
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    UpdateNotificationBadge: bindActionCreators(
      UpdateNotificationBadge,
      dispatch,
    ),
