...
const globalstyle = StyleSheet.create({
  ...
  headerTitleStyle: { fontFamily: isRTL ? fonts.arabicBold : fonts.primarySemiBold, fontSize: isIPad ? 22 : 18, textTransform: 'capitalize', color: isDarkMode ? colors.white : colors.white },
  ...
  detaildate: { fontFamily: isRTL ? fonts.arabicMedium : fonts.primaryMedium, color: isDarkMode ? colors.grey : colors.grey, marginBottom: 5, fontSize: isIPad ? 15 : 13, textAlign: 'left', marginBottom: isRTL ? 12 : 0 },
  detailtitle: { fontFamily: isRTL ? fonts.arabicBold : fonts.primarySemiBold, color: isDarkMode ? colors.black : colors.black, fontSize: isIPad ? 30 : 21, marginBottom: 5, textAlign: 'left', marginBottom: isRTL ? 10 : 0 },
  detaildescription: { fontFamily: isRTL ? fonts.arabicMedium : fonts.primary, color: isDarkMode ? colors.black : colors.black, fontSize: isIPad ? 18 : 15, textAlign: 'left', lineHeight: isRTL ? 28 : 22 },
  ...
  actionauthtext: { color: isDarkMode ? colors.black : colors.black, fontFamily: isRTL ? fonts.arabicBold : fonts.primarySemiBold, fontSize: isIPad ? 18 : fontSize },
  authlefticon: { color: isDarkMode ? colors.drawerbg : colors.drawerbg },
  // showhideicontouch: { padding: 10, zIndex: 1, position: 'absolute', right: 10, },
  // showhideicon: { color: '#999' },

  topicbgimage: { paddingHorizontal: 15, flex: 1 },
  topicheadingrow: { marginVertical: 15 },
  topicheading: { fontFamily: isRTL ? fonts.arabicMedium : fonts.primaryBold, fontSize: 22, textAlign: 'center', color: isDarkMode == 'dark' ? colors.black : colors.black, textTransform: 'capitalize', marginBottom: -5 },
  topicdesc: { fontFamily: isRTL ? fonts.arabicMedium : fonts.primaryMedium, fontSize: 15, textAlign: 'center', color: isDarkMode == 'dark' ? colors.black : colors.black },
  ...
  noproductfound: { fontFamily: isRTL ? fonts.arabicMedium : fonts.primary, color: colors.black }
